"""
Django settings for phoodServer project.
...
SECRET_KEY = '%wd(8a3%x8=3r9x_zjqd-2r^%94u2sxd0nnw1qg48#f!othkm9'
...
WSGI_APPLICATION = 'phoodServer.wsgi.application'
